...
For error logging ELMAH is used. To see the logs regarding the MVC application, you can browse the URL "http://localhost:1824/elmah.axd".
If the MVC project is running on the port 1824. Otherwise adjust the port number accordingly. 
